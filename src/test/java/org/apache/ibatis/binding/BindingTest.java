...
public class BindingTest {
  ...
  public static void setup() throws Exception {
    ...
    configuration.setUseActualParamName(false); // to com.it.test legacy style reference (#{0} #{1})
  ...
  public void shouldCacheMapperMethod() throws Exception {
    ...
    try {
      ...
      // Create another mapper instance with a method cache we can com.it.test against:
