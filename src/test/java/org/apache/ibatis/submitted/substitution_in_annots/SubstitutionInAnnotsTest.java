...
public class SubstitutionInAnnotsTest {
  ...
  public static void setUp() throws Exception {
    ...
    Environment environment = new Environment("com/it/test", new JdbcTransactionFactory(), new UnpooledDataSource("org.hsqldb.jdbcDriver", "jdbc:hsqldb:mem:annots", null));
